...
\begin{frame}{Τι θα ήταν τα μαθηματικά χωρίς πράξεις}
  ...
  \begin{itemize}[<+->]
    \item προσθέσω έναν αριθμό?
    \item αφαιρέσω έναν αριθμό?
    \item πολλαπλασιάσω με αριθμό πάνω από 1?
    \item διαιρέσω με αριθμό?
    \item υψώσω σε δύναμη?
    \item πολλαπλασιάσω με άλλο τόσο?
    \item αφαιρέσω άλλο τόσο?
    \item πολλαπλασιάσω με 0?
    \item διαιρέσω με άλλο τόσο?
  \end{itemize}
