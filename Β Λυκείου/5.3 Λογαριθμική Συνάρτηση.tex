...
\subtitle{Λογαριθμική Συνάρτηση}
...
\section{Θεωρία}
\begin{frame}{Και τελειώνουμεεεεεεε...}
  ΩΩΩΩ ναι!
\end{frame}

\begin{frame}{Λογαριθμική Συνάρτηση}
  Από τους λογάριθμους στις λογαριθμικές συναρτήσεις
  \begin{block}{Ορισμός}
    Για $α\in (0,+\infty)-\{1\}$, η συνάρτηση $f:(0,+\infty)$ με $f(x)=\log_a(x)$ ονομάζεται \emph{Λογαριθμική Συνάρτηση}
  \end{block}
  Από εδώ και πέρα ασχολούμαστε μόνο με $\ln$ οπότε
\end{frame}
