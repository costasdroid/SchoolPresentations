...
- **Αρχεία root**: `presentation.cls` (κεντρικό class, v2.7), `README.md`, `LICENSE` (CC BY-SA 4.0)
...
- **Δομή φακέλων**: Τα `.tex` αρχεία τοποθετούνται απευθείας στον φάκελο τάξης. Επιτρέπονται υποφάκελοι για:
  - Ξεχωριστές εκπαιδευτικές κατευθύνσεις (π.χ. `Κατεύθυνση/` στο Β Λυκείου)
  - Μεγάλες θεματικές ενότητες με πολλά αρχεία (π.χ. `Άλγεβρα/`, `Στατιστική/`)
  - Πόρους: `images/`, `moodle/`, `Methodology/`
  - **Όχι** υποφάκελος ανά μεμονωμένο θέμα/παρουσίαση
...
- Τα περιεχόμενα των frames να είναι σύντομα και περιεκτικά (όχι υπερβολικά αναλυτικά) — η λεπτομερής εξήγηση γίνεται προφορικά κατά τη διδασκαλία
...
- Μην επεξεργάζεσαι generated αρχεία (.pdf, .nav, .snm κλπ)
- Μην γράφεις στα αγγλικά
- Μην αγνοείς τη δομή υποφακέλων που ήδη υπάρχει (Άλγεβρα/, Κατεύθυνση/, Στατιστική/ κλπ)
